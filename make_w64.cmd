...
%MSVC%\cl.exe %CD%\keyboard.c %CD%\config.c %CD%\analog.c %CD%\main.c %incl% %C_FLAGS% /link %LINK_FLAGS%
%MSVC%\link.exe %LINK_FLAGS% /SUBSYSTEM:CONSOLE,5.2 keyboard.obj config.obj analog.obj main.obj
